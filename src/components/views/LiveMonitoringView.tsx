...
export const LiveMonitoringView: React.FC<LiveMonitoringViewProps> = ({
  ...
  // Hitung status tiap sensor berdasarkan nilai aktual & range
  const tempStatus = getSensorStatus(latest.temperature, 45, 65);
  const vibStatus = getSensorStatus(latest.vibration, 1.5, 4.5);
  const pressureStatus = getSensorStatus(latest.pressure, 5.5, 7.2);
  const rpmStatus = getSensorStatus(latest.rpm, 1600, 2000);
          ...
          <div className="space-y-3">
            ...
            >
              <div>
                ...
                <span className={`text-lg font-bold font-mono ${tempStatus.isExceeded ? 'text-red-400' : 'text-slate-900 dark:text-[#E1E4E6]'}`}>
              ...
              <span className={`px-2 py-0.5 rounded text-[10px] font-semibold ${tempStatus.bgClass} ${tempStatus.colorClass} border ${tempStatus.borderClass}`}>
                {tempStatus.label}
              </span>
            </div>
            ...
            >
              <div>
                ...
                <span className={`text-lg font-bold font-mono ${vibStatus.isExceeded ? 'text-red-400' : 'text-slate-900 dark:text-[#E1E4E6]'}`}>
            ...
            >
              <div>
                ...
                <span className={`text-lg font-bold font-mono ${pressureStatus.isExceeded ? 'text-red-400' : 'text-slate-900 dark:text-[#E1E4E6]'}`}>
                  {latest.pressure} bar
                </span>
                <span className="text-[10px] text-slate-400 dark:text-[#4B5259] block font-mono">
                  Range: 5.5–7.2 bar
              ...
              <span className={`px-2 py-0.5 rounded text-[10px] font-semibold ${pressureStatus.bgClass} ${pressureStatus.colorClass} border ${pressureStatus.borderClass}`}>
            ...
            >
              <div>
                ...
                <span className={`text-lg font-bold font-mono ${rpmStatus.isExceeded ? 'text-red-400' : 'text-slate-900 dark:text-[#E1E4E6]'}`}>
              ...
              <span className={`px-2 py-0.5 rounded text-[10px] font-semibold ${rpmStatus.bgClass} ${rpmStatus.colorClass} border ${rpmStatus.borderClass}`}>
                {rpmStatus.label}
              </span>
            </div>
          </div>
